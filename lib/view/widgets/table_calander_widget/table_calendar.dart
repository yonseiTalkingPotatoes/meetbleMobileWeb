...
import 'package:meetble/view/widgets/table_calander_widget/widgets/date_button.dart';
import 'package:simple_gesture_detector/simple_gesture_detector.dart';

import '../../../data/model/date_range_model.dart';
...
class TableCalendar<T> extends StatefulWidget {
  ...
  /// Called whenever any short cut gets tapped.
...
class _TableCalendarState<T> extends State<TableCalendar<T>> {
  ...
  void _selectShortCutDate(int index) {
    ...
    return Column(
      children: [
        ...
        Flexible(
          ...
          child: Container(
            decoration: widget.calendarStyle.calendarDecoration,
