  ...
  Widget build(BuildContext context) {
    return FrameScreenWidget(
        ...
        children: [
          StatefulBuilder(builder: (context, setState) {
            return TableCalendar(
              ...
              headerStyle: HeaderStyle(
                titleTextFormatter: (date, locale) => DateFormat.yMd(locale)
                    .format(Provider.of<JoinScreensViewModel>(context)
                        .selectedDate),
              ),
          ...
          TextField(
            controller: TextEditingController.fromValue(TextEditingValue(
                text: Provider.of<JoinScreensViewModel>(context)
                    .selectedDateStatus
                    .memo,
                selection: TextSelection.collapsed(
                    offset: (Provider.of<JoinScreensViewModel>(context,
                                listen: false)
                            .selectedDateStatus
                            .memo)
                        .length))),
                ...
                return TimePickerWidget(
                  ...
                  timeRange:
                      Provider.of<JoinScreensViewModel>(context, listen: false)
                          .createModel
                          .possibleTimes,
                  timeStatusList: Provider.of<JoinScreensViewModel>(context)
                      .selectedDateStatus
                      .timeBlock,
                  onTapTime: (int selectedTime) {
                    setState(() {
                      Provider.of<JoinScreensViewModel>(context, listen: false)
                          .toggleTimeState(selectedTime);
                    });
                  },
                );
              },
      ...
      onTapNext: () async {
        ...
        await Provider.of<JoinScreensViewModel>(context, listen: false)
            .registerJoinInfo();
        Provider.of<JoinScreensViewModel>(context, listen: false).resultSuccess
            ? {
                await Provider.of<ResultScreenViewModel>(context, listen: false)
                    .setMeetingId(Provider.of<JoinScreensViewModel>(context,
                            listen: false)
                        .userScheduleModel
                        .id),
                await Provider.of<ResultScreenViewModel>(context, listen: false)
                ...
                Navigator.pushAndRemoveUntil(
                    ...
                    MaterialPageRoute(
                        builder: (context) => ResultScreen(
                              meetingId: Provider.of<ResultScreenViewModel>(
                                      context,
                                      listen: false)
                                  .meetingId,
                            )),
                ...
                showDialog(
                    ...
                    builder: (context) {
                      return NotificationDialogWidget(
                        inputErrorMessage:
                            Provider.of<JoinScreensViewModel>(context)
                                .resultMessage!,
                        title: "입력이 올바르지 않습니다",
                      );
                    }),
