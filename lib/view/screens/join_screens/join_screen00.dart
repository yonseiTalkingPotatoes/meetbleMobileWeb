...
class JoinScreen00 extends StatefulWidget {
  ...
  const JoinScreen00({Key? key, required this.meetingId}) : super(key: key);
        ...
        child: FrameScreenWidget(
                    ...
                    controller: TextEditingController.fromValue(
                        TextEditingValue(
                            ...
                            selection: TextSelection.collapsed(
                                offset: (Provider.of<JoinScreensViewModel>(
                                            context,
                                            listen: false)
                                        .userScheduleModel
                                        .userName)
          ...
          onTapNext: () async {
            ...
            Provider.of<JoinScreensViewModel>(context, listen: false).inputOk
                ? {
                    await Provider.of<JoinScreensViewModel>(context,
                            listen: false)
                    ...
                    Provider.of<JoinScreensViewModel>(context, listen: false)
                        ...
                        ? {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => const JoinScreen01()))
                          }
                        : {
                            showDialog(
                                context: context,
                                builder: (context) {
                                  return NotificationDialogWidget(
                                    inputErrorMessage:
                                        Provider.of<JoinScreensViewModel>(
                                                context)
                                            .resultMessage!,
                                    title: "입력이 올바르지 않습니다",
                                  );
