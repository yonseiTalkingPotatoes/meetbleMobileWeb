  ...
  Widget build(BuildContext context) {
    return FrameScreenWidget(
            ...
            builder: (context, setState) {
              return TableCalendar(
                ...
                onDaySelected: (DateTime selectedDay, DateTime focusedDay){
                  setState((){
                    Provider.of<JoinScreensViewModel>(context, listen: false).toggleDateState(selectedDay);
                  });
                },
      ...
      onTapNext: () async {
        ...
        Provider.of<JoinScreensViewModel>(context, listen: false).updateImpossibleDates();
        Provider.of<JoinScreensViewModel>(context, listen: false).focusOnFirstDate();
        Navigator.push(context, MaterialPageRoute(builder: (context) => JoinScreen02()));
      },
    );
  }
}
